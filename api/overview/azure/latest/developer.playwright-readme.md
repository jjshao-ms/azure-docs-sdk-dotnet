...
---
# Azure Playwright client library for .NET - version 1.0.0 
...
To learn more about options for Microsoft Entra Id authentication, refer to [Azure.Identity credentials](https://github.com/Azure/azure-sdk-for-net/tree/Azure.Developer.Playwright_1.0.0/sdk/identity/Azure.Identity#credentials).
