...
ms.service: core
---
# Azure Core shared client library for .NET - version 1.47.0 
...
### Additional concepts
<!-- CLIENT COMMON BAR -->
[Client options](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/README.md#configuring-service-clients-using-clientoptions) |
[Accessing the response](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/README.md#accessing-http-response-details-using-responset) |
[Long-running operations](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/README.md#consuming-long-running-operations-using-operationt) |
[Handling failures](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/README.md#reporting-errors-requestfailedexception) |
[Diagnostics](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Diagnostics.md) |
...
More on client configuration in [client configuration samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Configuration.md).
...
More on response types in [response samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Response.md).
...
More on logging in [diagnostics samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Diagnostics.md).
...
More on handling responses in [response samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Response.md).
...
More on long-running operations in [long-running operation samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/LongRunningOperations.md).
...
More on request customization in [RequestContext samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/RequestContext.md).
...
More on diagnostics in [diagnostics samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Diagnostics.md).
...
Three main ways of troubleshooting failures are [inspecting exceptions](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Response.md#handling-exceptions), enabling [logging](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Diagnostics.md#Logging), and [distributed tracing](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.47.0/sdk/core/Azure.Core/samples/Diagnostics.md#Distributed-tracing)
...
[source]: https://github.com/Azure/azure-sdk-for-net/tree/Azure.Core_1.47.0/sdk/core/Azure.Core/src
