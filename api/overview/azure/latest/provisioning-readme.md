...
---
# Azure Provisioning client library for .NET - version 1.4.0 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning_1.4.0/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
