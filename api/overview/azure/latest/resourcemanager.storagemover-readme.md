...
To create an authenticated client and start interacting with Microsoft Azure resources, see the [quickstart guide here](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.StorageMover_1.3.0/doc/dev/mgmt_quickstart.md).
...
- [Quickstart](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.StorageMover_1.3.0/doc/dev/mgmt_quickstart.md).
- [API References](https://learn.microsoft.com/dotnet/api/?view=azure-dotnet).
- [Authentication](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.StorageMover_1.3.0/sdk/identity/Azure.Identity/README.md).
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.StorageMover_1.3.0/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
