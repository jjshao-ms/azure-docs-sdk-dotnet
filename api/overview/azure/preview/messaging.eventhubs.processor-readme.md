...
keywords: Azure, dotnet, SDK, API, Azure.Messaging.EventHubs.Processor, event-hubs
ms.date: 07/24/2024
ms.topic: reference
ms.devlang: dotnet
ms.service: event-hubs
---
# Azure Event Hubs Event Processor client library for .NET - version 5.12.0-alpha.20240724.1 
