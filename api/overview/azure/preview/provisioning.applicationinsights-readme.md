...
---
# Azure Provisioning client library for .NET - version 0.2.0-alpha.20240725.1 


Azure.Provisioning.ApplicationInsights simplifies declarative resource provisioning in .NET for Azure Application Insights.
