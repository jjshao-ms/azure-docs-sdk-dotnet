---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.IotOperations, iotoperations
ms.date: 01/01/2026
ms.topic: reference
ms.devlang: dotnet
...
To create an authenticated client and start interacting with Microsoft Azure resources, see the [quickstart guide here](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.IotOperations_1.1.0-beta.1/doc/dev/mgmt_quickstart.md).
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.IotOperations_1.1.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
